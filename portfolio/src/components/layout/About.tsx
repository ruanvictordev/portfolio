...
export default function About() {
  return (
    <div className="p-24 max-md:p-4" id="about">
      ...
      <section className="w-full flex justify-around items-center my-12 max-md:flex-col max-md:gap-4">
        <div>
          <img
            className="max-w-64 hidden rounded-full max-md:block"
