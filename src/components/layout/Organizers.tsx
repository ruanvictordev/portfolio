      ...
      <section className="w-full flex justify-center items-center my-12 max-md:flex-col">
        <div className="grid grid-cols-3 gap-x-32 gap-y-16 max-md:grid-cols-2 max-sm:grid-cols-1 max-lg:grid-cols-2 mx-auto">
          ...
          <div className="flex flex-col justify-center items-center gap-4">
            <Avatar className="w-32 h-32">
              <AvatarImage
                src="https://i.ibb.co/xqgYcfr/Whats-App-Image-2024-09-22-at-11-17-04.jpg"
                alt="Organizadora da Comunidade"
              />
            </Avatar>
            <div className="flex flex-col gap-2 text-center">
              ...
              <p>Organizer</p>
              <a href="https://www.linkedin.com/in/kelysoare5/">
                <Button className="px-2" variant={"outline"}>
                  <LinkedInLogoIcon />
                </Button>
              </a>
          ...
          <div className="flex flex-col justify-center items-center gap-4">
            <Avatar className="w-32 h-32">
              <AvatarImage
                src="https://i.ibb.co/VYQ9vRH/Whats-App-Image-2024-09-22-at-11-17-03.jpg"
                alt="Co-Organizador da Comunidade"
              />
            </Avatar>
            <div className="flex flex-col gap-2 text-center">
              ...
              <p>Desenvolvedor Frontend</p>
              <p>Co-Organizer</p>
              <a href="https://www.linkedin.com/in/bruno-lima-05aba3241/">
                <Button className="px-2" variant={"outline"}>
                  <LinkedInLogoIcon />
                </Button>
              </a>
